...
> **Tip:** To see how to install and manage your extensions, please refer to the [extension documentation](../editor/extension-marketplace.md).
...
Read more about setting up JavaScript linters in the VS Code [documentation](../languages/javascript.md#linters).
