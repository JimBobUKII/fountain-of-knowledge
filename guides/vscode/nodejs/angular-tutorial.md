...
`my-app` is the name of the folder for your application. This may take a few minutes to create the Angular application in [TypeScript](../languages/typescript.md) and install its dependencies.
