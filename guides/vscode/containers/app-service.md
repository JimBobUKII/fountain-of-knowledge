...
- A [**web** application](https://docs.microsoft.com/azure/app-service/containers/tutorial-custom-docker-image) that produces a docker image. You could also follow [Create a sample ASP .NET Core application](quickstart-aspnet-core.md) to create such application.
...
- [Azure Extensions](../azure/extensions.md) - The VS Code Marketplace has hundreds of extensions for Azure and the cloud.
- [Deploying to Azure](../azure/deployment.md) - Learn step-by-step how to deploy your application to Azure.
- [Working with MongoDB](../azure/mongodb.md) - Create, manage, and query MongoDB databases from within VS Code.
