...
This article covers troubleshooting tips and tricks for the Visual Studio Code [Docker](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-docker) extension. See the [Overview](overview.md) and quickstart articles for [Node.js](quickstart-node.md), [Python](python.md), or [ASP.NET](quickstart-aspnet-core.md) for details on setting up and working with Docker.
