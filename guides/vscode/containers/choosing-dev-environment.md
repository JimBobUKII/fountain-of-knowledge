...
1. Consider using a [development container](../remote/containers.md) first, if you need a remote environment.
...
For more information about how to set up debugging inside a container see [ASP.NET Core quickstart](quickstart-aspnet-core.md), [Node.js quickstart](quickstart-node.md), and [Docker extension task properties](reference.md) (`docker-build` and `docker-run` tasks).
