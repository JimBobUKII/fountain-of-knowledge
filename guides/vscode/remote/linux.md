...
* **Windows 10 / Server 2016/2019 SSH hosts** (1803+) using the [official OpenSSH Server](https://docs.microsoft.com/windows-server/administration/openssh/openssh_install_firstuse) and enabling `remote.SSH.useLocalServer` [in VS Code settings](../getstarted/settings.md).
...
If you are running Linux locally, the [VS Code prerequisites](../supporting/requirements.md) drive most of the requirements.
