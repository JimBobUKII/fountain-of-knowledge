...
This article covers frequently asked questions for each of the **Visual Studio Code Remote Development** extensions. See the [SSH](ssh.md), [Containers](containers.md), and [WSL](wsl.md) articles for more details on setting up and working with each of their respective capabilities. Or try the introductory [Tutorials](ssh-tutorial.md) to help get you running quickly in a remote environment.
...
You can find a list of locations VS Code itself needs access to in the [network connections article](../setup/network.md#common-hostnames).
...
* Install the [Remote - Containers](https://aka.ms/vscode-remote/download/containers) extension and use the [Remote Explorer](containers.md#option-1-use-the-containers-remote-explorer) in situations when you need to see your local containers.
...
* Use the [extensionKind property](containers.md#advanced-forcing-an-extension-to-run-locally-or-remotely) to force the extension to be `ui`. However, this will prevent some commands from working.
...
See [Remote Development with Linux](linux.md) for additional details.
...
See the [Visual Studio Code and 'Code - OSS' Differences](https://github.com/microsoft/vscode/wiki/Differences-between-the-repository-and-Visual-Studio-Code) and [Microsoft Extension Licenses](../supporting/oss-extensions.md) articles for more information.
...
The VS Code Remote Development extensions follow the GDPR policies as Visual Studio Code itself. See the [general FAQ](../supporting/faq.md#gdpr-and-vs-code) for more details.

## Questions or feedback

Have a question or feedback?

* See [Tips and Tricks](troubleshooting.md).
