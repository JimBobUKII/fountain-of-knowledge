...
This documentation describes the legacy Tasks system in Visual Studio Code version 1.13 and earlier. If you want to learn about the latest Tasks 2.0, please refer to the [Tasks](tasks.md) topic.
...
- **silent** - The output window is brought to front only if no [problem matchers](tasks.md#processing-task-output-with-problem-matchers) are set for the task.
...
2. [Automation of the compile step with a file watcher](../languages/markdown.md#automating-markdown-compilation)
...
* [Code Navigation](editingevolved.md) - Move quickly through your source code.* [Language Support](../languages/overview.md) - Learn about our supported programming languages, both shipped with VS Code and through community extensions.
