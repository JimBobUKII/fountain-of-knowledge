...
>**Note:** If you prefer to not see the Code Action lightbulb in your editor, you can disable lightbulbs with the `editor.lightbulb.enable` [setting](../getstarted/settings.md). You can still open Quick Fixes through **Quick Fix** command and `kb(editor.action.quickFix)` keyboard shortcut.
...
* [Code Navigation](editingevolved) - VS Code lets you move quickly through your source code.
* [Debugging](debugging.md) - Learn about debugging with VS Code.
