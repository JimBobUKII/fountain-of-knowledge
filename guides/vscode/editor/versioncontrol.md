...
Visual Studio Code has integrated source control management (SCM) and includes [Git](https://git-scm.com/) support in-the-box. Many other source control providers are available through [extensions](extension-marketplace.md) on the VS Code Marketplace.
...
>**👉** When you commit, be aware that if your username and/or email is not set in your Git configuration, Git will fall back to using information from your local machine. You can find the details in [Git commit information](https://git-scm.com../git-commit#_commit_information).
...
>**Note**: If you'd like to work on a repository without cloning the contents to you local machine, you can install the [GitHub Repositories](https://marketplace.visualstudio.com/items?itemName=github.remotehub) extension to browse and edit directly on GitHub. You can learn more in the [GitHub Repositories extension](github.md#github-repositories-extension) section.
...
Visual Studio Code supports more Git history workflows through [extensions](extension-marketplace.md) available on the VS Code Marketplace.
...
* [Intro Video - Git Version Control](../introvideos/versioncontrol.md) - An introductory video providing an overview of VS Code Git support.
...
* [Tasks](tasks.md) - Running tasks with Gulp, Grunt, and Jake.  Showing Errors and Warnings
