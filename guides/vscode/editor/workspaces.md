...
* Persist [task](tasks.md) and [debugger launch](debugging.md) configurations that are only valid in the context of that workspace.
...
Refer to the [settings](../getstarted/settings.md) documentation for a comprehensive explanation of setting scopes and their file locations.
...
Refer to [tasks](tasks.md) and [debugging](debugging.md) chapters for a more comprehensive overview of how to use tasks and launch configurations in VS Code.
