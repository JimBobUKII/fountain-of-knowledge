...
* [Working with C#](../csharp.md) - Learn about the great C# support you'll have when working on your .NET Core application.
...
* [Deploying Applications to Azure](../azure/deployment.md) - Deploy your app to [Azure](https://azure.microsoft.com).
