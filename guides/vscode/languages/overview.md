...
Go to the [Marketplace](https://marketplace.visualstudio.com/vscode) or use the integrated [Extensions view](../editor/extension-marketplace.md) and search for your desired programming language to find snippets, code completion/IntelliSense providers, linters, debuggers, and more.

>**Note**: If you want to change the display language of VS Code (for example, to Chinese), see the [Display Language](../getstarted/locales.md) topic.

## Language specific documentation

Learn about programming languages supported by VS Code. These include: [C++](../cpp.md) - [C&#35;](../csharp.md) - [CSS](../css.md) - [Dart](https://dart.dev/tools/vs-code) - [Dockerfile](../azure/docker.md) - [F&#35;](../dotnet.md#create-an-f-hello-world-app) - [Go](../go.md) - [HTML](../html.md) - [Java](../java.md) - [JavaScript](../javascript.md) - [JSON](../json.md) - [Less](../css.md) -
[Markdown](../markdown.md) - [PHP](../php.md) - [PowerShell](../powershell.md) - [Python](../python.md) - [SCSS](../css.md) - [T-SQL](../tsql.md) - [TypeScript](../typescript.md).
...
You can find a list of known identifiers in the [language identifier reference](../identifiers.md).

## Adding a file extension to a language

You can add new file extensions to an existing language with the `files.associations` [setting](../getstarted/settings.md).
...
* [Code Navigation](../editor/editingevolved.md) - Peek and Go to Definition and more
...
Yes, with the `files.associations` [setting](../getstarted/settings.md) you can map file extensions to an existing language either globally or per workspace.
...
Using the `files.defaultLanguage` [setting](../getstarted/settings.md), you can map all new files to a default language. Whenever a new blank file is opened, the editor will be configured for that language mode.
