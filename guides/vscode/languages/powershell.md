...
[Visual Studio Code User Guide](../editor/extension-marketplace.md) or by going directly to the Visual Studio Code Marketplace and clicking the [Install Button](vscode:extension/ms-vscode.PowerShell).
...
The PowerShell extension uses the built-in debugging interface of VS Code to allow for debugging of PowerShell scripts and modules. You can learn more about [VS Code debugging](../editor/debugging.md) here.
...
You can customize VS Code [settings](../getstarted/settings.md) from the **File** > **Preferences** > **Settings** menu item (**Code** > **Preferences** > **Settings** on macOS).
...
Go to [User and Workspace settings](../getstarted/settings.md) for more information on configuring VS Code settings.
