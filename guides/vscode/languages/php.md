...
Visual Studio Code is a great editor for PHP development. You get features like syntax highlighting and bracket matching, IntelliSense (code completion), and snippets out of the box and you can add more functionality through community-created VS Code [extensions](../editor/extension-marketplace.md).
...
There are three [settings](../getstarted/settings.md) to control the PHP linter:
...
* [Extension Marketplace](../editor/extension-marketplace.md) - Browse the extensions others have shared
* [Debugging](../editor/debugging.md) - Learn more about VS Code debugging
