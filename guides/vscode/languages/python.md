...
To experience Python, create a file (using the [File Explorer](../getstarted/userinterface.md#explorer)) named `hello.py` and paste in the following code (assuming Python 3):
...
For a more specific walkthrough on running code, see the [tutorial](../python/python-tutorial.md).

## Autocomplete and IntelliSense

The Python extension supports code completion and IntelliSense using the currently selected interpreter. [IntelliSense](../editor/intellisense.md) is a general term for a number of features, including intelligent code completion (in-context method and variable suggestions) across all your files and for built-in and third-party modules.
...
The Python extension can apply a number of different linters including Pylint, pycodestyle, Flake8, mypy, pydocstyle, prospector, and pylama. See [Linting](../python/linting.md).
...
For Python-specific details, including setting up your `launch.json` configuration and remote debugging, see [Debugging](../python/debugging.md). General VS Code debugging information is found in the [debugging document](../editor/debugging.md). The [Django](../python/tutorial-django.md) and [Flask](../python/tutorial-flask.md) tutorials also demonstrate debugging in the context of those web apps, including debugging Django page templates.
...
The Python extension automatically detects Python interpreters that are installed in standard locations. It also detects conda environments as well as virtual environments in the workspace folder. See [Configuring Python environments](../python/environments.md). You can also use the `python.pythonPath` setting to point to an interpreter anywhere on your computer.
...
VS Code prompts you with a list of detected environments as well as any you've added manually to your user settings (see [Configuring Python environments](../python/environments.md)).

### Installing packages

Packages are installed using the **Terminal** panel and commands like `pip install <package_name>` (Windows) and `pip3 install <package_name>` (macOS/Linux). VS Code installs that package into your project along with its dependencies. Examples are given in the [Python tutorial](../python/python-tutorial.md#install-and-use-packages) as well as the [Django](../python/tutorial-django.md) and [Flask](../python/tutorial-flask.md) tutorials.
...
Using either method, Notebook Editor or a Python file, you can also connect to a remote Jupyter server for running the code. For more information, see [Jupyter support](../datascience/jupyter-notebooks.md).

## Testing

The Python extension supports [testing](../python/testing.md) with the unittest, pytest, and nose test frameworks.
...
The Python extension provides a wide variety of settings for its various features. These are described on their relevant topics, such as [Editing code](../python/editing.md), [Linting](../python/linting.md), [Debugging](../python/debugging.md), and [Testing](../python/testing.md). The complete list is found in the [Settings reference](../python/settings-reference.md).
...
- [Python Hello World tutorial](../python/python-tutorial.md) - Get started with Python in VS Code.
- [Editing Python](../python/editing.md) - Learn about auto-completion, formatting, and refactoring for Python.
...
- [Django tutorial](../python/tutorial-django.md)
- [Flask tutorial](../python/tutorial-flask.md)
