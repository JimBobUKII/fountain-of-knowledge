...
Support for Java in Visual Studio Code is provided through a wide range of [extensions](../editor/extension-marketplace.md). Combined with the power of core VS Code, these extensions give you a lightweight and performant code editor that also supports many of the most common Java development techniques.
...
<a class="tutorial-next-btn" href="../java/java-tutorial">Java Getting Started Tutorial</a>
...
**NOTE:** If you are using VS Code on Windows and want to take advantage of the Windows Subsystem for Linux, see [Developing in WSL](../remote/wsl).

Before you start, you must have the Java SE Development Kit (JDK) on your local environment. To run the VS Code for Java extension, Java SE 11 or above version is required; for projects, VS Code for Java supports projects with version 1.5 or above. For how to configure, refer to [Configure JDK](../java/java-project.md#configure-jdk).
...
A "multi-root workspace" can refer to multiple folders (directories) from disparate parts of the file system and VS Code displays the contents of the folder(s) of the workspace together in the [File Explorer](../getstarted/userinterface.md#basic-layout). To learn more, see [Multi-root Workspaces](../editor/multi-root-workspaces.md).
...
<video autoplay loop muted playsinline controls>
  <source src="../java/package-viewer.mp4" type="video/mp4">
</video>

Visual Studio Code also supports working with standalone Java files outside of a Java project, described in the [Java Tutorial with VS Code](../java/java-tutorial.md).
...
More details about Java project support can be found in [Java Project Management in Visual Studio Code](../java/java-project.md) and [Build Tools](../java/java-build.md).
...
<video autoplay loop muted playsinline controls>
  <source src="../java/resolve-main.mp4" type="video/mp4">
</video>

Although it's lightweight, the Java debugger supports advanced features such as expression evaluation, conditional breakpoints, and hot code replacement. For more debugging related information, visit [Java Debugging](../java/java-debugging.md).
...
<video autoplay loop muted playsinline controls>
  <source src="../java/testng.mp4" type="video/mp4">
</video>

For more about testing, read [Testing Java](../java/java-testing.md).
...
<video autoplay loop muted playsinline controls>
  <source src="../java/tomcat.mp4" type="video/mp4">
</video>

See [Application Servers](../java/java-tomcat-jetty.md) to learn more about support for Tomcat and Jetty as well as other application servers with VS Code.
...
See [Spring Boot with VS Code](../java/java-spring-boot.md) to learn more about Spring Boot support with VS Code and also [Deploy to Azure Web Apps](../java/java-webapp.md) or [Deploy to Azure Spring Cloud](../java/java-spring-cloud.md) to learn more about deploying Spring apps to Azure from VS Code.
...
* [Java Tutorial with VS Code](../java/java-tutorial.md)
* [Code Editing and Navigation](../java/java-editing.md)
* [Java Debugging](../java/java-debugging.md)
* [Java Testing](../java/java-testing.md)
* [Java Project Management](../java/java-project.md)
* [Spring Boot with VS Code](../java/java-spring-boot.md)
* [Tomcat and Jetty Support](../java/java-tomcat-jetty.md)
* [Azure with VS Code](../java/java-on-azure.md)

Read on to find out more about Visual Studio Code:

* [Basic Editing](../editor/codebasics.md) - Learn about the powerful VS Code editor.
