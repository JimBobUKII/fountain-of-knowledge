...
Now press `kb(workbench.action.files.save)` to save the file. You can also enable [Auto Save](../editor/codebasics.md#saveauto-save) to automatically save your file changes, by checking **Auto Save** in the main **File** menu.
...
- [GCC on Windows via MinGW](../cpp/config-mingw.md)
- [Microsoft C++ on Windows](../cpp/config-msvc.md)
- [GCC on Linux](../cpp/config-linux.md)
- [GCC on Windows Subsystem For Linux](../cpp/config-wsl.md)
- [Clang/LLVM on macOS](../cpp/config-clang-mac.md)
- [CMake Tools on Linux](../cpp/cmake-linux.md)

## Documentation

You can find more documentation on using the Microsoft C/C++ extension under the [C++ section](../cpp) of the VS Code website, where you'll find topics on:

- [Debugging](../cpp/cpp-debug.md)
- [Editing](../cpp/cpp-ide.md)
- [Settings](../cpp/customize-default-settings-cpp.md)
- [FAQ](../cpp/faq-cpp.md)
...
VS Code and the C++ extension support [Remote Development](../remote/remote-overview.md) allowing you to work over SSH on a remote machine or VM, inside a Docker container, or in the [Windows Subsystem for Linux](https://docs.microsoft.com/windows/wsl) (WSL).
