...
The C# support in Visual Studio Code is optimized for cross-platform .NET Core development (see [working with .NET Core and VS Code](../dotnet.md) for another relevant article). Our focus with VS Code is to be a great editor for cross-platform C# development.
...
For a full description of our editing features, go to the [Basic Editing](../editor/codebasics.md) and [Code Navigation](../editor/editingevolved.md) documentation.
...
>**Tip:** You can add in your own User Defined Snippets for C#. Take a look at [User Defined Snippets](../editor/userdefinedsnippets.md) to find out how.
...
>**Tip:** You can turn off references information displayed in CodeLens with the `editor.codeLens` [setting](../getstarted/settings.md).
...
* [.NET Core Development](../dotnet.md) - get up and running with cross-platform .NET
...
* [Unity development](../other/unity.md) - Learn about using VS Code with your Unity projects.
...
VS Code supports tasks for build and natively understand the output of MSBuild, CSC, XBuild. Find out more in the [Tasks](../editor/tasks.md) documentation.
